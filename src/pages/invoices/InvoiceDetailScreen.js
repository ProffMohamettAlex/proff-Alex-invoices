        ...
        >
            ...
            >
              ...
              >
                <p className="font-bold mb-2">
                  {invoiceForm?.companyDetail?.companyName || "LiiBaaN Yare SuperMarket { 1 }"}
                </p>
                ...
                <p className="text-sm font-medium">
                  {invoiceForm?.companyDetail?.companyMobile || "LiiBaaN Store 1 "}
                </p>
                <p className="text-sm font-medium">
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title flex-1"> INVOICE #ID</div>
              ...
              {!isViewMode && (
                <div className="flex flex-row justify-between items-center mb-1">
                  <div className="font-title flex-1"> NooCa Lacagta </div>
                  <div className="font-title flex-1 text-right">
                    <input
                      autoComplete="nope"
                      placeholder="Invoice No"
          ...
          <div className="py-2 px-4">
            ...
            >
              ...
              >
                <span className="inline-block">Magaca ALaabta</span>
              </div>
              <div
                className={
                  "font-title " +
